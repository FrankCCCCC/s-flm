...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/sudoku/eflm_rescale_variational_${DIFFICULTY}}"
...
VAR_SCOPE="${VAR_SCOPE:-positional}"  # positional (learned decoding order) / global
VAR_CONTEXT="${VAR_CONTEXT:-prompt}"  # prompt (MuLAN D.1, clue-adaptive) / dlm-state
VAR_DEGREE="${VAR_DEGREE:-5}"        # polynomial degree (odd)
