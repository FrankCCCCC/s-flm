#!/bin/bash
# EFLM rescale + AUTONOMOUS clock, truncation sweep — eval ONE TinyStories
...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/tinystories/eval/eflm_rescale_auto_truncation}"
DEVICES="${DEVICES:-1}"
EVAL_BS="${EVAL_BS:-16}"
STEPS="${STEPS:-180}"
