...
- ``rho``: ``rho_min`` == ``rho_max``
  - (`rho`, `tau_max`) : {(0.05, 4.6649), (0.1, 3.9811), (0.5, 2.4436), (1.0, 1.8338)}
...
- Training
  ...
  - Optimizer: AdamW
    - LR: {3e-4, 1e-3}, Weight Decay: 0.0
    - Betas: (0.9, 0.999), eps: 1e-8, Gradient Clip: 1.0
  - All use cross entropy loss * {w/o SNR}
  - Seed: {1, 2, 3}
  - Save Checkpoint every 1K steps, keep every checkpoint
...
VARY R, LR, and truncation timestep to find the optimal GenPPL without collapsing